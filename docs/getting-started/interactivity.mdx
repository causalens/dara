...
from dara.components import Stack, Text, Input, Button
...
page_content = Stack(
    ...
    # You will learn about actions in the next section
...
page_content = Stack(
    ...
    Text(text=f'Current theme: {theme_class}')
)
```
