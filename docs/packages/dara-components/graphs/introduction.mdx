...
You can read more about `fCoSE` and more available layouts in the [reference documentation](../../reference/dara/components/graphs/graph_layout) and the layout docstrings.
