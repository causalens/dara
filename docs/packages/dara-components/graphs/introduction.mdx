...
Default legends is structured slightly differently. By default it takes a dict of key EditorMode and legends array value. This is so the correct default
