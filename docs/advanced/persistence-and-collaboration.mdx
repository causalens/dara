...
In order to make the aforementioned default behaviour more customizable to suit different needs, `Variable` accepts
a `store` property. It can be used to customize the source of truth for a given `Variable`.
