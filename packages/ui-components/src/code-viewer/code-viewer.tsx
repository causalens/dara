...
import { Code } from '@darajs/ui-icons';
...
const TopButtonContainer = styled.span`
    :hover {
...
export interface CodeViewerProps extends InteractiveComponentProps<string> {
    ...
    /** The event handler on advanced code copy*/
    onAdvancedCopy?: (value: string) => void | Promise<void>;
    /** The text to display on the advanced code copy button */
    advancedCodeCellCopyText?: string;
}
        ...
        >
            <TopBar $isLightTheme={props.codeTheme !== 'dark'}>
                ...
                <TopButtonsWrapper>
                    ...
                    {props.onAdvancedCopy && (
                        <TopButtonContainer
                            style={{ cursor: 'pointer' }}
                            onClick={() => props.onAdvancedCopy(props.value)}
                            role="button"
                        >
                            <Code /> {props.advancedCodeCellCopyText}
                        </TopButtonContainer>
                    )}
                </TopButtonsWrapper>
            </TopBar>
