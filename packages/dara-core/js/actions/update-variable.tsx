...
import { getAtom, useVariable, useVariableValue } from '@/shared/interactivity';
...
import { ActionContext, ActionHandler, UpdateVariableImpl, UpdateVariableInstance } from '@/types/core';
