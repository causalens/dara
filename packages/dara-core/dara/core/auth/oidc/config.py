...
OIDCAuthLogin = AuthComponent(js_source='@darajs/core/auth/oidc/oidc-login', py_module='dara.core')

OIDCAuthLogout = AuthComponent(js_source='@darajs/core/auth/oidc/oidc-logout', py_module='dara.core')

OIDCAuthSSOCallback = AuthComponent(js_source='@darajs/core/auth/oidc/sso-callback', py_module='dara.core')
