...
class DataVariable(AnyDataVariable):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        var_entry = DataVariableRegistryEntry(cache=cache, uid=str(self.uid), type='plain', get_data=DataVariable.get_value, get_total_count=DataVariable.get_total_count)
