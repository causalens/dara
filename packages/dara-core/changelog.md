...
- Added opt-in, vendor-neutral OpenTelemetry traces, logs, and metrics through Pydantic Logfire, covering HTTP,
  authentication and OIDC, actions, WebSockets, internal operations, tasks, workers, scheduled jobs, cross-process W3C
  propagation, bounded privacy-aware attributes, and process identity while preserving the existing Prometheus
  endpoint.
