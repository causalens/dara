...
config.router.add_page(name='interactivity', content=page_content)
```
...
So far you have learned how to handle your app's information and interactivity by declaratively defining yourderived variables and components. You will learn about responding to user interaction.
